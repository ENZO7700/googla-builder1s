...
export const PostSchema = z.object({
  ...
  content: z.object({ rendered: z.string() }).passthrough().optional(),
  excerpt: z.object({ rendered: z.string() }).passthrough().optional(),
  status: z.string(),
  date: z.string(),
  modified: z.string(),
  author: z.number(),
...
const PluginAuthorSchema = z.union([
  z.string(),
  z.object({ rendered: z.string() }).passthrough(),
]);
...
export const PluginSchema = z.object({
  ...
  ...plugin,
  author: typeof plugin.author === 'string' ? { rendered: plugin.author } : plugin.author,
  active: plugin.active ?? (plugin.status === 'active' || plugin.status === 'network-active'),
...
export const SettingsSchema = z.object({
  ...
  gmt_offset: z.coerce.number().optional(),
  ...
  pages_per_page: z.coerce.number().optional(),
}).passthrough();
