(function () {
  ...
  function buildForm(container, schema, opts) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      // checkboxes: include false for unchecked
      fields.forEach(function (f) {
        if (f.type === 'checkbox' && !(f.key in payload)) payload[f.key] = false;
        else if (f.type === 'checkbox') payload[f.key] = true;
      });
